 ...
 * @author huyke
 */
public class AdidasController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int start = (page - 1) * 6;
            int end = Math.min(size-1, page*6-1);
            ArrayList<Product> listP =p.getProductByPage(listAll,start,end);
